...
function fly_gamelist_boxes(){  
  add_meta_box("gamelist-meta", __('Games Listings Page Options', 'doubledown'), "fly_gameslist_metabox", "page", "advanced", "low");
}  
...
<div class="fly_box">
	<p class="label">
	<label><?php _e('Number of Games Per Page To Show', 'doubledown'); ?>:</label>
	</p>
...
<div class="fly_box">
	<p class="label">
	<label><?php _e('Filter By Games Tag', 'doubledown'); ?>:</label>
	</p>
...
<div class="fly_box">
	<p class="label">
	<label><?php _e('Filter by Game Type', 'doubledown'); ?>:</label>
	</p>
...
<div class="fly_box">
	...
	<select name="_gl_games_orderby" id="_gl_games_orderby">
    	     	 <option <?php if ($games_orderby == "title") echo 'SELECTED'; ?> value="title"><?php _e('Title', 'doubledown'); ?></option>
                 <option <?php if ($games_orderby == "menu_order") echo 'SELECTED'; ?> value="menu_order"><?php _e('Menu Order', 'doubledown'); ?></option>
                 <option <?php if ($games_orderby == "date") echo 'SELECTED'; ?> value="date"><?php _e('Date', 'doubledown'); ?></option>
                 <option <?php if ($games_orderby == "_gm_rating") echo 'SELECTED'; ?> value="_gm_rating"><?php _e('Rating', 'doubledown'); ?></option>
		<option <?php if ($games_orderby == "Rand") echo 'SELECTED'; ?> value="rand"><?php _e('Random', 'doubledown'); ?></option>
    	</select>
	</div>
