...
{
	add_submenu_page('design-options', __('Redirect Options', 'doubledown'), __('Redirect Options', 'doubledown'), 'update_themes', 'redirect-options', 'redirect_show_ui');
...
<style>
	...
	<div class="wrap meta-box-sortables">
        ...
        <h2><?php _e('Custom Redirects', 'doubledown'); ?></h2>
        ...
        <div id="poststuff">
	        ...
	        <table class="redirects_table widefat" width=620>
            	<thead>
                	<tr>
                    	<th width=120><?php _e('Redirect Key', 'doubledown'); ?></th>
                        <th width=400><?php _e('Url', 'doubledown'); ?></th>
                        <th width=75><?php _e('Hits', 'doubledown'); ?></th>
                        <th width=160><?php _e('Actions', 'doubledown'); ?></th>
					</tr>
				</thead>
                <tbody>
                ...
                <?php if (count($redirects) == 0) : ?>
                	<tr>
                    	<td colspan="4"><em><?php _e('No custom redirects', 'doubledown'); ?></em></td>
					</tr>
                <?php else: ?>
                    ...
                    <tr>
                        ...
                        <td>
                        	<span><a href="#" onclick="editRow(this)"><?php _e('Edit', 'doubledown'); ?></a> | </span>
                        	<a href="?page=redirect-options&action=delete-redirect&key=<?php echo $redirect['key'];?>"><?php _e('Delete', 'doubledown'); ?></a> | 
                        	<a href="?page=redirect-options&action=reset-redirect&key=<?php echo $redirect['key'];?>"><?php _e('Reset Hits', 'doubledown'); ?></a></td>
                    </tr>
                    <?php endforeach; ?>
            ...
            <br />
            <input class="button-secondary" type="submit" name="action" value="<?php _e('Save Changes', 'doubledown'); ?>" />
		</form>
        <script>
        ...
        <br />
        <h3><?php _e('Create a custom redirect', 'doubledown'); ?></h3>
...
?>
        ...
        <form method="post" action="?page=redirect-options">
            <label><?php _e('Key', 'doubledown'); ?>:</label>
            <input type="text" name="key" value="<?php echo $mykey;?>" />
            <label><?php _e('URL', 'doubledown'); ?>:</label>
            <input style="width: 200px" name="url" value="<?php echo $myurl;?>" type="text" />
            <input class="button-primary" type="submit" name="action" value="<?php _e('Create Redirect', 'doubledown'); ?>" />
		</form>
		</div><!--poststuff-->
