...
function __construct() {
		parent::__construct(
			'fly-fb', // Base ID
			__( 'Feedburner Newsletter Signup', 'doubledown' ), // Name
			array( 'description' => __( 'Add a feedburner signup form to widget area.', 'doubledown' ), ) // Args
		);
	}	
...
<p>
<label for="<?php echo $this->get_field_id('username'); ?>"><?php _e('Feedburner User:', 'doubledown'); ?></label>
...
<p>
<label for="<?php echo $this->get_field_id('email'); ?>"><?php _e('Email Label:', 'doubledown'); ?></label>
...
<p>
<label for="<?php echo $this->get_field_id('submitlabel'); ?>"><?php _e('Submit Label:', 'doubledown'); ?></label>
...
<p>
<label for="<?php echo $this->get_field_id('imgfield'); ?>"><?php _e('Image (Optional):', 'doubledown'); ?></label>
...
<?php _e('To be placed under the title to the right - size 80x80px.', 'doubledown'); ?>
<p>

<label for="<?php echo $this->get_field_id('textabove'); ?>"><?php _e('Text Above Email Input (Optional):', 'doubledown'); ?></label>
...
<p>		
<input style="width:20px;" class="widefat" type="checkbox" <?php if ($instance['counterlink']) echo 'CHECKED'; ?> name="<?php echo $this->get_field_name('counterlink'); ?>" /> <?php _e('Check to show number of subscribers counter.', 'doubledown'); ?>
</p>
