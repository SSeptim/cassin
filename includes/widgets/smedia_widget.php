...
function __construct() {
		parent::__construct(
			'fly-smedia', // Base ID
			__( 'Social Media Icons', 'doubledown' ), // Name
			array( 'description' => __( 'Add social media icons to a widget area.', 'doubledown' ), ) // Args
		);
	}	
...
<p><strong><?php _e('Enter the url for your social social media pages below that you would like to display in the widget below.  Leave blank to hide icon.', 'doubledown'); ?></strong></p>


<p>
<label for="<?php echo $this->get_field_id('facebookurl'); ?>">Facebook <?php _e('Page URL', 'doubledown'); ?>:</label>
...
<p>
<label for="<?php echo $this->get_field_id('twitterurl'); ?>">Twitter <?php _e('Page URL', 'doubledown'); ?>:</label>
...
<p>
<label for="<?php echo $this->get_field_id('googleurl'); ?>">Google Plus <?php _e('Page URL', 'doubledown'); ?>:</label>
...
<p>
<label for="<?php echo $this->get_field_id('pinturl'); ?>">Pinterest <?php _e('Page URL', 'doubledown'); ?>:</label>
...
<p>
<label for="<?php echo $this->get_field_id('instaurl'); ?>">Instagram <?php _e('Page URL', 'doubledown'); ?>:</label>
...
<p>
<label for="<?php echo $this->get_field_id('youtubeurl'); ?>">Youtube <?php _e('Page URL', 'doubledown'); ?>:</label>
...
<p>
<label for="<?php echo $this->get_field_id('linkedinurl'); ?>">Linkedin <?php _e('Page URL', 'doubledown'); ?>:</label>
...
<p>
<label for="<?php echo $this->get_field_id('flickrurl'); ?>">Flickr <?php _e('Page URL', 'doubledown'); ?>:</label>
...
<p>
<label for="<?php echo $this->get_field_id('tumblrurl'); ?>">Tumblr <?php _e('Page URL', 'doubledown'); ?>:</label>
...
<p>
<label for="<?php echo $this->get_field_id('stumbleurl'); ?>">Stumbleupon <?php _e('Page URL', 'doubledown'); ?>:</label>
...
<p>
<label for="<?php echo $this->get_field_id('rssurl'); ?>">RSS <?php _e('Page URL', 'doubledown'); ?>:</label>
...
<p>
<label for="<?php echo $this->get_field_id('iconsize'); ?>"><?php _e('Widget Display Variation', 'doubledown'); ?>:</label>
...
<p>		
<input style="width:20px;" class="widefat" type="checkbox" <?php if ($instance['targetwindow']) echo 'CHECKED'; ?> name="<?php echo $this->get_field_name('targetwindow'); ?>" /><?php _e('Check to open links in new window.', 'doubledown'); ?>
</p>
