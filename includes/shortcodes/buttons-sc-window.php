...
<div id="cdf_shortcode_dialog" class="flytonic_sc_editor" title="Custom Buttons" style="display:none;">
	...
	<div>
    	<label for=""><?php _e('Button Text', 'doubledown'); ?></label>
    	<input class="fly_textinput" type="text" name="fly_button_text" id="text" size="40">
    	<p><?php _e('Enter Button Text', 'doubledown'); ?></p>
   	</div>	 

	<div>
    	<label for=""><?php _e('Button URL', 'doubledown'); ?></label>
    	<input class="fly_textinput" type="text" name="fly_button_text" id="linkurl" size="40">
    	<p><?php _e('Enter Button URL', 'doubledown'); ?></p>
   	</div>	 

	<div>
    	<label><?php _e('Size of Button', 'doubledown'); ?></label>
    	<select class="fly_textinput" name="size" id="size">
    	     	<option value="reg"><?php _e('Regular', 'doubledown'); ?></option>
		<option value="sm"><?php _e('Small', 'doubledown'); ?></option>
		<option value="med"><?php _e('Medium', 'doubledown'); ?></option>
               	 <option value="lg"><?php _e('Large', 'doubledown'); ?></option>
	...
	<div>
    	...
    	<select class="fly_textinput" name="icon" id="icon">
    	     	<option value="none"><?php _e('None (Default)', 'doubledown'); ?></option>
               	 <option value="darrow"><?php _e('Down Arrow', 'doubledown'); ?></option>
		<option value="info"><?php _e('Info', 'doubledown'); ?></option>
		<option value="error"><?php _e('Error', 'doubledown'); ?></option>
		<option value="check"><?php _e('Check', 'doubledown'); ?></option>
   		<option value="warning"><?php _e('Warning', 'doubledown'); ?></option>
    	</select>
	...
	<div>
    	<label><?php _e('Text Color', 'doubledown'); ?></label>
    	<select class="fly_textinput" name="text_color" id="text_color">
    	     	<option value="lgt"><?php _e('Light', 'doubledown'); ?></option>
                <option value="drk"><?php _e('Dark', 'doubledown'); ?></option>
    	</select>
	...
	<div>
    	<label><?php _e('Background Color', 'doubledown'); ?></label>
    	<select class="fly_textinput" name="bg_color" id="bg_color">
    	     	<option value="normal"><?php _e('Normal', 'doubledown'); ?></option>
...
<option value="black">Black</option>
		<option value="custom"><?php _e('Custom', 'doubledown'); ?></option>
	...
	<div id="cdf_bg_color_custom" style="display:none;">
    	<label for="tag-name"><?php _e('Custom Background Color', 'doubledown'); ?></label>
    	<input type="text" name="bg_color_custom" id="bg_color_custom" class="cdf-bg-color-field" size="40" />
    	<p><?php _e('Select or enter a custom background color for the button', 'doubledown'); ?></p>
      </div>
