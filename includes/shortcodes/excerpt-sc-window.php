...
.flytonic_sc_editor p {margin:0 0 10px 0; padding:0; font-size:12px; font-style:italic; color:#666;}	
 ...
 <div id="excerpt_editor" class="flytonic_sc_editor" title="Recent Posts Shortcode"  style="display:none">
	...
	<div>
    	<label><?php _e('Number of Posts (3=Default)', 'doubledown'); ?></label>
    	<input class="fly_textinput" type="text" name="excerpt_num" id="excerpt_num" size="10">
   	</div>	  
	

	<div>
    	<label><?php _e('Show only titles', 'doubledown'); ?></label>
    	<input class="fly_textinput" id="excerpt_titles" type="checkbox" value="Y" />
	<p><?php _e('Check the box if you want to show posts as a list with titles only.', 'doubledown'); ?></p>
	</div>

	<div>
    	<label><?php _e('Filter by Category', 'doubledown'); ?></label>
	...
	<p><?php _e('You can choose to show posts within a certain category.', 'doubledown'); ?></p>
	</div>
