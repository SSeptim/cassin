 ...
 <div id="fly_boxes" class="flytonic_sc_editor" title="Alert Boxes Shortcode"  style="display:none">
	...
	<div>
    	...
    	<select class="fly_textinput" name="box_style" id="box_style">
    	     	<option value="info"><?php _e('Info Box', 'doubledown'); ?></option>
		<option value="check"><?php _e('Check Box', 'doubledown'); ?></option>
               	 <option value="download"><?php _e('Download Box', 'doubledown'); ?></option>
		<option value="error"><?php _e('Error Box', 'doubledown'); ?></option>
   		<option value="alert"><?php _e('Alert Box', 'doubledown'); ?></option>
    	</select>

	</div>

	<div>
    	<label><?php _e('Alert Box Text', 'doubledown'); ?></label>
	<textarea class="fly_textinput" id="box_body" style="width: 100%; height: 80px;"></textarea>
	<p><?php _e('Enter text here or within the post itself', 'doubledown'); ?></p>
   	</div> 
