...
.flytonic_sc_editor p {margin:0 0 10px 0; padding:0; font-size:12px; font-style:italic; color:#666;}	
	...
	<div id="bcb2_editor" class="flytonic_sc_editor" title="<?php _e('Fixed Casino Listings', 'doubledown'); ?>"  style="display:none">
	...
	<div>
    	<label><?php _e('Casino 2 Optional', 'doubledown'); ?></label>
    	<select class="fly_textinput" name="casino2" id="casino2">
    	     <option value="">[<?php _e('Optional', 'doubledown'); ?>]</option>
		<?php foreach ($casinos as $h) { ?>
        	<option value="<?php echo $h->ID?>"><?php echo $h->post_title?></option>
        	<?php } ?>
	</select>
	...
	<div>
    	<label><?php _e('Casino 3 Optional', 'doubledown'); ?></label>
	...
	<div>
    	<label><?php _e('Casino 4 Optional', 'doubledown'); ?></label>
	...
	<div>
    	<label><?php _e('Casino 5 Optional', 'doubledown'); ?></label>
	...
	<div>
    	<label><?php _e('Casino 6 Optional', 'doubledown'); ?></label>
	...
	<div>
    	<label><?php _e('Casino 7 Optional', 'doubledown'); ?></label>
	...
	<div>
    	<label><?php _e('Casino 8 Optional', 'doubledown'); ?></label>
		...
		<div>
    	<label><?php _e('Casino 9 Optional', 'doubledown'); ?></label>
		...
		<div>
    	<label><?php _e('Casino 10 Optional', 'doubledown'); ?></label>
